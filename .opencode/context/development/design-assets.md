...
/>
<img
  src="https://source.unsplash.com/random/1200x800/?people"
  alt="People image"
/>
```
...
<!-- With text -->
<img
  src="https://placehold.co/800x600?text=Product+Image"
...
<div
  class="w-full h-64"
  style='background-image: url(&apos;data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80"><path fill="%23f0f0f0" d="M0 0h80v80H0z"/><path fill="%23e0e0e0" d="M0 0h40v40H0zm40 40h40v40H40z"/></svg>&apos;)'
></div>
```
